...
@NgModule({
  ...
  providers: [
    ...
    Network,  DatePipe, Push, Camera, UniqueDeviceID,FileTransfer,
    File, InAppBrowser,SocialSharing, PhotoViewer, FilePath,
    FileChooser,  HTTP,
    FileOpener,DocumentViewer,MobileAccessibility,
  ],
