...
export class LoginPage implements OnInit {
  ...
  constructor(public alertController: AlertController, public events: Events, public loadingController: LoadingController, public navCtrl: NavController, public helper: Helper, public apiClient: APIClient, public webServer: WebServer, public platform: Platform, public toastController: ToastController, private router: Router, public actionSheetController: ActionSheetController, private network: Network, private formBuilder: FormBuilder, private loadingCtrl: LoadingController, private apiservice: APIService, private http: HttpClient, private storage: Storage, private menuctrl: MenuController) {
                ...
                response => {
                    ...
                    if ( this.successvalue.success === 1) {
                        ...
                        if (this.postloginresponce.verification_status_id == 1) {
                            this.verifyStatusId = this.postloginresponce.verification_status_id;
                            this.storage.set('perform_id',5);
                            this.navCtrl.navigateRoot(['/home/']);
