...
export class CountrycodelistPage implements OnInit {
  ...
  constructor(public httpClient: HttpClient, private storage: Storage, public platform: Platform, private navctrl: NavController, private loadingCtrl: LoadingController, public navCtrl: NavController, public rest: DataService, private router: Router) {
    this.presentLoading();
