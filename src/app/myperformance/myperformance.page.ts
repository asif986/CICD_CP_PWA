...
export class MyperformancePage implements OnInit {
  ...
  getPreformance() {
    this.presentLoading().then(() => {
      if (this.network.type !== 'none' && this.network.type !== 'unknown') {
        this.apiservice.getMyPerformance(this.cp_executive_id, this.api_token,this.from_date,this.to_date).subscribe(data => {
      ...
      if (this.network.type !== 'none' && this.network.type !== 'unknown') {
        this.apiservice.getMyPerformance(this.cp_executive_id, this.api_token,this.from_date,this.to_date).subscribe(data => {
          ...
          if (Value.success === 1) {
            ...
            this.leads_site_visits = this.PerformanceList[this.selectedCategoryId].leads_site_visits;
            this.leads = this.PerformanceList[this.selectedCategoryId].leads;
            this.lead_tokens = this.PerformanceList[this.selectedCategoryId].lead_tokens_ghp;
            this.lead_tokens_ghp_plus = this.PerformanceList[this.selectedCategoryId].lead_tokens_ghp_plus;
            this.booking_master = this.PerformanceList[this.selectedCategoryId].booking_master;
            this.dismissLoading();
            console.log(this.PerformanceList);
            console.log(this.selectedCategory);
            console.log(this.leads_site_visits);
  ...
  getmyPerformancevalue(index: any) {
    ...
    this.lead_tokens_ghp_plus = this.PerformanceList[index].lead_tokens_ghp_plus;
